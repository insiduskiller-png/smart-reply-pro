    ...
    [
      {
        role: "system",
        content:
          "Analyze communication power dynamics. Return strict JSON with keys: score (0-100 number), leverage (string), risks (array of strings), manipulation_detected (boolean).",
      },
