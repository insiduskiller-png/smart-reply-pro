...
export const PRO_WAITLIST_EMAIL = "support@smartreplypro.ai";
export const PRO_WAITLIST_SUBJECT = "Smart Reply Pro waitlist request";
export const PRO_WAITLIST_BODY = "Please notify me when Smart Reply Pro is available.";
